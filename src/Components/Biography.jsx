...
export default function Biography() {
    return (
        <section id="section-2" className="px-10  flex justify-center items-center pt-20 text-[#1B1C1E]">
            <div className="flex flex-col justify-center  items-center gap-1 max-w-[640px] sm:max-w-[100%]  justify-items-center ">
                <div className="flex justify-between items-center  w-full pb-6">
                    <div>
                        <h2 className="text-[30px] font-bold uppercase">biography</h2>
                        <p className="text-lg ">A short account of Queen elizabeth II's Life</p>
                    </div>
                </div>
                <div className="flex flex-col justify-center">
                    <div className="flex justify-center gap-5 flex-wrap">
                        <div className="flex flex-col sm:w-[400px] sm:h-[300px] px-1">
                            <img src={Rect6} alt="" className="w-[100%]  aspect-[1.5]" aria-hidden="true" />
                        </div>
                        <div className="flex flex-col  sm:w-[400px] sm:h-[300px] px-1">
                            <img src={Rect5} alt="" width="100%" aria-hidden="true" />

                        </div>
                        <div>
                            <div className="flex flex-col    sm:w-[400px] sm:h-[300px] px-1 space-y-5">
                    ...
                    <div className="flex justify-center gap-5 flex-wrap">
                        <div className="flex flex-col sm:w-[400px] sm:h-[400px] px-1 ">
                            <img src={Rect7} alt="" className="w-full aspect-square" aria-hidden="true" />
                        </div>
                        <div className="flex flex-col  sm:w-[400px] sm:h-[400px] gap-10 px-1 ">
                            ...
                            <div className="">
                                <a href="#" className="flex items-center gap-1 text-lg font-bold ">Read More<img src={Arrow} aria-hidden="true"width="30px" alt="" /></a>
                            </div>
                        </div>
                        <div>
                            <div className="flex flex-col sm:w-[400px] sm:h-[400px] px-1 ">
                                <img src={Rect8} alt="" width="100%" aria-hidden="true" />
                            </div>
                        </div>
                    </div>
                </div>
